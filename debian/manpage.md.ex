% wxdatefrom(SECTION) | User Commands
%
% "May  7 2023"
...
wxdatefrom - program to do something

# SYNOPSIS

**wxdatefrom** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**wxdatefrom** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **wxdatefrom** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**wxdatefrom** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    wxdatefrom. See **foo.conf**(5) for further details.
...
**wxdatefrom** provides some return codes, that can be used in scripts:
...
Giulio Sorrentino <gsorre84@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Giulio Sorrentino
